...
set ext_dma [lindex $::argv 9]
set commit_hash [lindex $::argv 10]
...
create_root_design $stacktype $en_dma $en_arith $en_compress $en_extkrnl $mb_debug_level $ext_dma $commit_hash
