...
proc dma_debug {idx} {
    ...
    connect_bd_intf_net [get_bd_intf_pins ila_dma${idx}/SLOT_0_AXIS] -boundary_type upper [get_bd_intf_pins dma_${idx}/dma_mm2s_cmd]
    connect_bd_intf_net [get_bd_intf_pins ila_dma${idx}/SLOT_1_AXIS] -boundary_type upper [get_bd_intf_pins dma_${idx}/dma_s2mm]
    connect_bd_intf_net [get_bd_intf_pins ila_dma${idx}/SLOT_2_AXIS] -boundary_type upper [get_bd_intf_pins dma_${idx}/dma_s2mm_cmd]
    connect_bd_intf_net [get_bd_intf_pins ila_dma${idx}/SLOT_3_AXIS] -boundary_type upper [get_bd_intf_pins dma_${idx}/dma_s2mm_sts]
    connect_bd_intf_net [get_bd_intf_pins ila_dma${idx}/SLOT_4_AXIS] -boundary_type upper [get_bd_intf_pins dma_${idx}/dma_mm2s]
    connect_bd_intf_net [get_bd_intf_pins ila_dma${idx}/SLOT_5_AXIS] -boundary_type upper [get_bd_intf_pins dma_${idx}/dma_mm2s_sts]
}
